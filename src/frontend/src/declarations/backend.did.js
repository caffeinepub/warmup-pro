...
export const idlService = IDL.Service({
  ...
  'addExercise' : IDL.Func(
      [IDL.Text, IDL.Text, ExternalBlob, ExternalBlob, IDL.Nat],
      [],
      [],
    ),
  'find' : IDL.Func([IDL.Text], [Exercise], ['query']),
  'getAllExercises' : IDL.Func([], [IDL.Vec(Exercise)], ['query']),
  'getNextExercise' : IDL.Func([IDL.Text], [Exercise], ['query']),
  'getPreviousExercise' : IDL.Func([IDL.Text], [Exercise], ['query']),
});
