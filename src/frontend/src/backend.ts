...
import type { Exercise as _Exercise, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addExercise(arg0: string, arg1: string, arg2: ExternalBlob, arg3: ExternalBlob, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addExercise(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async find(arg0: string): Promise<Exercise> {
        if (this.processError) {
            try {
                const result = await this.actor.find(arg0);
                return from_candid_Exercise_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getNextExercise(arg0: string): Promise<Exercise> {
        if (this.processError) {
            try {
                const result = await this.actor.getNextExercise(arg0);
                return from_candid_Exercise_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPreviousExercise(arg0: string): Promise<Exercise> {
        if (this.processError) {
            try {
                const result = await this.actor.getPreviousExercise(arg0);
                return from_candid_Exercise_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Exercise_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Exercise): Promise<Exercise> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        order: value.order,
        video: await from_candid_ExternalBlob_n11(_uploadFile, _downloadFile, value.video),
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Exercise>): Promise<Array<Exercise>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Exercise_n9(_uploadFile, _downloadFile, x)));
}
